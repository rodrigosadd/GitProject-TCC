...
public class PlayerAttackController : MonoBehaviour
{
     ...
     {
          if (Input.GetButtonDown("Fire1") && !GameManager.instance.instanceSettingsData.settingsOpen && PlayerController.instance.movement.slowed == false && (PlayerController.instance.movement.stateCharacter == CharacterState.RUNNNING || PlayerController.instance.movement.stateCharacter == CharacterState.IDLE) && !PlayerController.instance.death.dead)
          {
               if (!attaking)
               {
